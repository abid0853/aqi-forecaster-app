...
def get_sensor_data():
    ...
    try:
        waqi_api_key = "863296fb81e839b073505ca569860cdf03f1ce80" # Using provided API key
        city = None
        
        # --- Attempt to get city name from coordinates for the new URL format ---
        try:
            # Use the Open-Meteo API for reverse geocoding
            ...
            # The 'results' key might not exist or be empty
